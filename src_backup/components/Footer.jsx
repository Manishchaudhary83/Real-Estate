      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="text-gray-400">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam fuga repellendus reiciendis, illo ipsam sequi fugiat reprehenderit, aperiam accusamus iure consequuntur. Odit, animi voluptates?
          </p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="p-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none flex-1"
            />
